...
//初始化区域图的对象
	...
	width = "100%";
	height = "100%";
	this.$bgDiv.append("<div class='GooFlow_work' style='width:"+(width)+";height:"+(height)+";'></div>");
	this.$workArea=$("<div class='GooFlow_work_inner' style='width:100%;height:100%;'></div>")
...
jQuery.extend({
	createGooFlow2:function(bgDiv,property){
